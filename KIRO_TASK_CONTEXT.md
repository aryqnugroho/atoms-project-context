...
| CNSD-009 | T-DME Meter Reading | TDME-METER (FORM N-5) | ✅ Live | `/cnsd/tdme-meter` |
| CNSD-010 | DVOR Meter Reading | DVOR-METER (FORM N-5) | ✅ Live | `/cnsd/dvor-meter` |
| CNSD-011+ | DME, ATC System, ATIS | — | 🚧 Coming Soon | — |
...
- T-DME: `TDME-YYMMDD-SEQ` (contoh: `TDME-260519-001`)
- DVOR: `DVOR-YYMMDD-SEQ` (contoh: `DVOR-260519-001`)
